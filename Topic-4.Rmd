...
mean(knn.pred != mpg01.test)
```
When k=1, 11.413% error
When k=10, 11.957% error
When k=100, 5.4348% error
When k=200, 5.4348% error

Around 100 seems to be the best K.
...
#mean(glm.pred != crime01.test)
```
18.18% error, 18.58% error for complex and simple models, respectively.
...
mean(lda.pred$class != crime01.test)
```
13.44% error, 11.86% error for complex and simple models, respectively.
